$( document ).ready(function() {
    ...
    //     console.log(1);
    //     let block = $(".calculate").offset().top
    //     let block1 = $(".customizable").offset().top - 200
    //     var st = $(this).scrollTop();
    //     if(st > block ){
    //         if (st > lastScrollTop) {
    //             $('.calculate__item:nth-child(2)').animate({top: '-=13'},0);
    //             $('.calculate__item:nth-child(1)').animate({top: '+=13'},0);
    //         }
    //         else {
    //             $('.calculate__item:nth-child(2)').animate({top: '+=13'},0);
    //             $('.calculate__item:nth-child(1)').animate({top: '-=13'},0);
...
$( document ).ready(function() {
    ...
    // function dotsSlide(navId) {
    //     if (navId + 1 != slideNow) {
    //
    //         $(".feature__slide").removeClass("active")
    //
    //         slideWidth = -$('.feature__slide').innerWidth() * (navId);
    //
    //         $('.feature__slides').css({
    //             'transform': 'translate(' + slideWidth + 'px, 0)',
    //             '-webkit-transform': 'translate(' + slideWidth + 'px, 0)',
    //             '-ms-transform': 'translate(' + slideWidth + 'px, 0)',
    //         });
    //
    //         slideNow = navId + 1;
    //
    ...
    //             $(".feature__inner").css({top: 0 + 'px'}, 0)
    //         } else {
    //             $(".feature__inner").css({top: (-featureItemWidth * navId) + featureItemWidth + 'px'}, 0)
    //
    //         }
    //     }
    // }
...
$(document).ready(function () {
    ...
    function validateEmailPopup(e) {
        ...
        if (errorValue == 0) {
            $.ajax({
                url: '/wp-content/themes/ultrabootstrap/mail.php',
                type: 'POST',
                contentType: false,
                processData: false,
                data: {
    ...
    $(".popup__body .btn").on("click", validateEmailPopup)
})
